...
@Component({
  selector: 'app-ngselect-test',
  imports: [NgSelectModule,FormsModule,ReactiveFormsModule,CommonModule],
  templateUrl: './ngselect-test.component.html',
  styleUrl: './ngselect-test.component.scss'
})
export class NgselectTestComponent implements OnInit {
